...
public class Sorcier extends Personnage{
    ...
    public Sorcier(String nomPersonnage, int hpMax, int hpCourant, int manaMax, int manaCourant, int expMax, int expCourant, int level, int levelMax, int degatPersonnage, Skill1 skill1, Skill2 skill2, int dameSkill1, int dameSkill2, int manaSkill1, int manaSkill2, String crierDeGuerre, int force, String competance, int dexterite, int constitution, int intelligence) {
